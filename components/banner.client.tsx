...
export default function Banner() {
  const handleOnClick = () => {console.log('hi banner')}
  return (
    <div className='mb-12 grid lg:mb-24 lg:grid-cols-2'>
      <div className='z-20 flex flex-col px-2 md:pt-12'>
        ...
        <p className='font-sans text-xl font-semibold text-gray-900 md:mt-5 lg:text-2xl'>Discover your local coffee shops!</p>
        <div className='mt-12'>
